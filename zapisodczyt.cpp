...
bool ZapisOdczytSTDIO::zapisz(ListaProduktow * lista, char nazwa[])
{
...
bool ZapisOdczytSTDIO::odczytaj(ListaProduktow * lista, char nazwa[])
{
...
bool ZapisOdczytIOStream::zapisz(ListaProduktow * lista, char nazwa[])
{
...
bool ZapisOdczytIOStream::odczytaj(ListaProduktow * lista, char nazwa[])
{
    ifstream plik(nazwa);
    if(!plik.is_open())
        return false;
